          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <div className="flex items-start justify-between gap-2">
                <h3 className={`text-lg font-semibold ${isCompleted ? 'line-through text-gray-400' : 'text-white'}`}>
                  {todo.taskTitle}
                </h3>
                <button
                  type="button"
              ...
              {isExpanded && (
                <div className="mt-4 space-y-3 border-t border-blue-400/10 pt-4">
                  {todo.taskDescription && (
                    <p className="text-base text-gray-300">{todo.taskDescription}</p>
                  )}
                  {todo.constraints && (
                  ...
                  <div className="p-4 bg-gradient-to-br from-green-500/10 to-green-600/5 rounded-lg border border-green-400/30">
