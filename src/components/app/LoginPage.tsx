    ...
    <div className="min-h-screen bg-gradient-to-br from-[#1a2744] via-[#1e3a5f] to-[#0f1225] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">TRAORE GESTION PROJET</h1>
        ...
        <Card className="bg-white/95 backdrop-blur-sm shadow-xl border-0">
          ...
          <CardContent>
            ...
            <div className="mt-6 p-4 bg-amber-50 rounded-lg border border-amber-200">
              <p className="text-xs font-medium text-amber-700 mb-2">Identifiants par défaut :</p>
              <div className="space-y-1 text-sm text-amber-600">
                <p><span className="font-medium">Email:</span> admin@traoreprojet.com</p>
        ...
        <p className="text-center text-blue-200/50 text-sm mt-6">
          © 2024 Traore Gestion Projet. Tous droits réservés.
        </p>
      </div>
    </div>
  )
